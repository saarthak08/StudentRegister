...
public class StudentDataAdapter extends RecyclerView.Adapter<StudentDataAdapter.StudentViewHolder>{
    ...
    public StudentViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        StudentListItemBinding studentListItemBinding= DataBindingUtil.inflate(LayoutInflater.from(viewGroup.getContext()),R.layout.student_list_item,viewGroup,false);
